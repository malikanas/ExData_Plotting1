...
par(mfrow=c(2,2))
with(subPower_data, plot(FullTimeDate, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(subPower_data, plot(FullTimeDate, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(subPower_data, plot(FullTimeDate, Sub_metering_1, type="l", xlab="", ylab="Energy Sub Metering"))
...
with(subPower_data, plot(FullTimeDate, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()